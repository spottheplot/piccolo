/**********************************************************************
* File: SysCtrl.c -- Solution File for Lab 2, 3 and 4
...
// instead of doing the initialization here.
	...
	{													// PLL is not running in limp mode
		...
		SysCtrlRegs.PLLCR.bit.DIV = 0x0010;				// PLLx16/4 (because DIVSEL is /4)
		...
		// After the PLL has locked, we are running in PLLx16/4 mode (since DIVSEL is /4).
